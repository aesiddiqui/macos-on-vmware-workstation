...
| **[2 · Obtaining macOS](part2-obtaining-macos.md)** | Pulling a recovery image from Apple's own servers and converting it to a format Workstation will boot (**VMDK, not ISO**) | ✅ **Validated** 2026-08-11 — 3 versions built and **all three booted and installed** |
| **[3 · VM creation & install](part3-vm-creation-and-install.md)** | Wizard settings, the version-dropdown trap, the single-socket rule, Disk Utility, the install itself | ✅ **Validated on THREE versions** 2026-08-11 — Ventura 13, Sequoia 15, Tahoe 26, with the Setup Assistant drift between them |
| **[4 · Post-install](part4-post-install.md)** | VMware Tools, clipboard, shared folders, and headless **SSH** access | ✅ **Validated on THREE versions** 2026-08-11 — SSH-reachable guests; bash 3.2 / BSD `sed` / no `tac` **identical on 13, 15 and 26** |
