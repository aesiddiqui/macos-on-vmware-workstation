...
| **[3 · VM creation & install](part3-vm-creation-and-install.md)** | Wizard settings, the version-dropdown trap, `smc.version`, Disk Utility, the install itself | 🔄 **In progress** — VM config and boot to Recovery validated; install underway |
